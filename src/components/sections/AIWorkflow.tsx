      ...
      <div className="w-full max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="font-display text-[36px] md:text-[48px] lg:text-[56px] tracking-tight text-[#08302a] leading-[1.055]">
            <span className="text-[#12a170]">Six stages. Zero raw PHI</span><br className="hidden md:block" />
            leaves your walls.
          </h2>
        </div>
        ...
        >
          {stages.map((stage, index) => (
            <motion.div
              ...
              className="bg-white border border-[#f0ebe1]/50 shadow-[0_8px_30px_rgba(0,0,0,0.04)] rounded-[32px] p-8 md:p-10 flex flex-col hover:-translate-y-1 transition-transform duration-300 relative overflow-hidden"
            >
              {/* Top Row: Icon & Number */}
              <div className="flex items-center justify-between mb-8 relative z-10">
                <div className="w-12 h-12 rounded-full bg-[#08302a] flex items-center justify-center text-white shadow-[0_0_24px_rgba(0,195,122,0.4)] border border-[#00c37a]/20">
