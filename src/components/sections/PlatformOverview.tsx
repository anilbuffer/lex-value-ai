    ...
    <SectionContainer className="bg-background-warm" id="platform">
      <div className="w-full max-w-[1100px] mx-auto px-6">
        ...
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="font-display text-[36px] md:text-[48px] lg:text-[52px] tracking-tight text-[#08302a] leading-[1.1] max-w-2xl mx-auto mb-8">
            Everything a modern PI firm needs —<br className="hidden md:block" />
        ...
        >
          {ecosystemCategories.map((category, index) => (
            <motion.div
              ...
              className="bg-white rounded-[32px] p-8 md:p-10 shadow-sm border border-white/50 relative overflow-hidden flex flex-col hover:-translate-y-1 transition-transform duration-300"
            >
              ...
              <div className="relative z-10">
                {/* Icon */}
                <div className="w-14 h-14 rounded-full bg-[#107e5c] flex items-center justify-center text-white mb-8 shadow-sm">
