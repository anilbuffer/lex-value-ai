    ...
    <SectionContainer className="bg-background-warm" id="founder-story">
      <div className="w-full max-w-[1000px] mx-auto px-6">
        <motion.div
          ...
          className="bg-white border border-white shadow-[0_8px_40px_rgba(0,0,0,0.03)] rounded-[24px] md:rounded-[48px] p-8 md:p-16 lg:p-20 relative overflow-hidden flex flex-col items-center text-center"
        >
          ...
          <div className="relative z-10 w-full flex flex-col items-center">
            ...
            <div className="flex items-center gap-4">
              <div className="section-icon">
                <Quote size={20} className="text-[#00c37a]" />
              </div>
