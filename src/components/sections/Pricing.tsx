      ...
      <div className="w-full max-w-[1100px] mx-auto px-6">
        ...
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-10">
          ...
          <h2 className="font-display text-[34px] md:text-[42px] lg:text-[48px] tracking-tight text-[#08302a] leading-[1.055] mb-8">
            Enterprise-ready plans <br className="hidden md:block" /> that scale
        ...
        <div className="grid md:grid-cols-3 gap-6 items-stretch">
          {plans.map((plan, index) => (
            ...
            >
              ...
              {/* CTA Button */}
              <Button
                className={`w-full h-[52px] rounded-[14px] text-[15px] font-bold transition-all border-none shadow-sm ${plan.theme === 'dark'
